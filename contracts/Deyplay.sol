...
contract Deyplay {
    ...
    //Events
    event TrackCreated(uint id, string title, string description, address artist, string imageUrl, string audioFile, uint price, uint streamAmount, address[] royaltiesOwners, uint[] royaltiesPercentages);
